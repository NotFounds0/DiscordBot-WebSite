                ...
                <div className="flex gap-10 items-center">
                    ...
                    <div className="">
                        <ul className='hidden md:flex gap-3 text-[15px] font-medium'>
                            <li>
                                <Link href={'/'} className={router.pathname === '/' ? 'text-white underline underline-offset-8 decoration-blue-600' : 'text-blue-500 hover:text-blue-600'}>Home</Link>
                            </li>
                            <li>
                                <Link href={'/Commands'} className={router.pathname === '/Commands' ? 'text-white underline underline-offset-8 decoration-blue-600 ' : 'text-blue-500 hover:text-blue-600'}>Komutlar</Link>
                            </li>
                            <li>
                                <Link href={'/About'} className={router.pathname === '/About' ? 'text-white underline underline-offset-8 decoration-blue-600' : 'text-blue-500 hover:text-blue-600'}>Hakkımızda</Link>
                            </li>
                            <li>
